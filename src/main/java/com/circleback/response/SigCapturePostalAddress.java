...
public class SigCapturePostalAddress {
	...
	public String toString() {
		return "SigCapturePostalAddress [street1=" + street1 + ", street2=" + street2 + ", city=" + city + ", state="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SigCapturePostalAddress other = (SigCapturePostalAddress) obj;
		if (city == null) {
			if (other.city != null)
				return false;
